...
function showhtml() {
   ...
   if (opC.checked == true) { document.getElementById("1Aexp").innerHTML = n + "wrongexp"; document.getElementById("1Bexp").innerHTML = n + "wrongexp"; document.getElementById("1Cexp").innerHTML = n + "correctexp"; document.getElementById("1Dexp").innerHTML = n + "wrongexp"; }

   if (opD.checked == true) { document.getElementById("1Aexp").innerHTML = n + "wrongexp"; document.getElementById("1Bexp").innerHTML = n + "wrongexp"; document.getElementById("1Cexp").innerHTML = n + "wrongexp"; document.getElementById("1Dexp").innerHTML = n + "correctexp"; }
